...
function merge(arr1, arr2) {
  ...
  while (index1 < arr1.length && index2 < arr2.length) {
    ...
    const compareValue1 = Number(currentElement1.league_id) * 10 + Number(currentElement1.matchweek)
    const compareValue2 = Number(currentElement2.league_id) * 10 + Number(currentElement2.matchweek)
